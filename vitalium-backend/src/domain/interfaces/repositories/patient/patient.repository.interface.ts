...
export interface IPatientRepository {
  ...
  findAllByDoctorId(doctorId: string, unitId?: string): Promise<Patient[]>;
  findAllByUnitId(unitId: string): Promise<Patient[]>;
  ...
  findPrimaryActiveUnitId(patientId: string): Promise<string | null>;
}
